...
Ниже — разбор не только «железа», но и контекста, SLA, процессов и экономики эксплуатации.
...
### 1.3 Обоснование
Главный критерий — **минимальный TCO (total cost of ownership)**: важна не только абонплата, но и трудозатраты на администрирование. Сложные HA‑кластеры тут экономически не оправданы, а риск аппаратного сбоя компенсируется бэкапами и простойностью восстановления.
